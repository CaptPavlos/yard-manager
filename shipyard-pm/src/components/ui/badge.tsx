  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        "in-progress": "border-transparent bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400",
        completed: "border-transparent bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400",
        blocked: "border-transparent bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400",
        // Priority variants
        low: "border-transparent bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400",
        ...
        // Maritime
        maritime: "border-transparent bg-navy-100 text-navy-800 dark:bg-navy-900/30 dark:text-navy-300",
        gold: "border-transparent bg-gold-100 text-gold-800 dark:bg-gold-900/30 dark:text-gold-400",
      },
    },
    defaultVariants: {
      variant: "default",
